                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php
                                    $data_rekam_medis = mysqli_query($con_pusat, "SELECT rm.*, p.id_pendonor, p.nama_pendonor FROM data_rekam_medis rm INNER JOIN data_pendonor p ON rm.kd_pendonor = p.id_pendonor");
