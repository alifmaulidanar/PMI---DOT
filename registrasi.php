            ...
            <div class="container">
                <div class="row align-items-center justify-content-center py-4">
                    <div class="col-lg-5 col-md-10 col-sm-10 text-center text-white">
                            ...
                            <h3 class="mb-0">PALANG MERAH INDONESIA</h3>
                    ...
                    <div class="col-lg-6 col-md-10 col-sm-10">
                        ...
                        <form method="POST">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-2">
                                        ...
                                        <input type="number" class="form-control-custom" placeholder="kg" id="beratbadan" name="beratbadan" required>
                                    </div> 
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <label for="cabang" class="form-label">Cabang PMI</label>
                                <select class="form-select" id="cabang" aria-label="Default select" name="cabang" required>
                                    <option selected value="<?= $_SESSION['pmiuser']['nama_cabang']; ?>"> <?= $_SESSION['pmiuser']['nama_cabang']; ?> </option>
                                </select>
                            </div>
