...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/login-rs.css">
        <!-- Fonts -->
    ...
    <body>
        <div class="bungkus">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center py-4">
                    ...
                    <h4 class="mb-3 text-center text-white">Login - Rumah Sakit</h4>
        ...
        <?php
            ...
            if(isset($_POST['login'])){
                ...
                // Query Input data
                $sqlquery = $con_pusat->query("SELECT * FROM user_rs WHERE username='$uname' AND password='$pass'");
